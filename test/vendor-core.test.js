...
describe('vendored core — digests match the pin', () => {
  ...
  it('the CORE is one released tag; the rest of the set keeps its own provenance', () => {
    ...
    assert.match(text, /receipt-verifier \*\*v1\.0\.3\*\*/,
    ...
    assert.match(text, /source_commit: 523e0a2b822088990f500b9eea3868309439c53c/,
  ...
  it('the vendored core is byte-identical to the SIGNED receipt-verifier v1.0.3', (t) => {
